...
- +1.: Please pay attention to formatting the code correctly, it makes it easier to read and maintain. You can even use plugins for that, but a simple terraform fmt can make a day and night difference also!